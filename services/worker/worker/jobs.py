"""Job-type registry for the worker.

The actual job handlers (sync, parse, embed, xrepo, distill) are implemented in Phase 1+
as thin wrappers over py_core. This module just defines the known job types and a guard,
so enqueue/consume code can validate payloads early.
"""
